...
#define MAX_MSG_LEN 64   // may be increased if necessary to max 251

static const hm2_modbus_chan_descriptor_t channels[] = {
/*  {TYPE,     FUNC, ADDR,   COUNT, pin_name} */
    {HAL_FLOAT,   3,   0x83FB,	1,	"output_freq_fb"},
    {HAL_FLOAT,   3,   0x83FD,	5,	"output_info"},
    {HAL_FLOAT,   3,   0x8405,	2,	"power-energy"},
    {HAL_U32,   3,   0x83F6,	2,	"state-fault"},
    {HAL_FLOAT,	6, 0x8121,	1,	"output-frequency"},
    {HAL_U32,	6, 0x8122,	1,	"output-action"},
